...
echo "** Touch job file to process job testjob "
touch $wiperdog_home/var/job/testjob.job
echo "** Touch trigger "
...
name:"test_class" , concurrency : 10
eof
echo "** Touch job file to process job"
touch $wiperdog_home/var/job/testjob.job
...
# name:"test_class" , concurrency : 10
# eof
# cat > $wiperdog_home/var/job/testclass_2.cls <<eof
...
# echo "** Touch job file to process job testjob2"
# touch $wiperdog_home/var/job/testjob2.job
